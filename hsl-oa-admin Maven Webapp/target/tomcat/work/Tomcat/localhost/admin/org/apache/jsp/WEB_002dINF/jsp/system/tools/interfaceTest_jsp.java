 ...
 * Generated at: 2017-09-21 06:02:04 UTC
...
public final class interfaceTest_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/jsp/system/tools/../index/foot.jsp", Long.valueOf(1505284427743L));
    _jspx_dependants.put("/WEB-INF/jsp/system/tools/../index/top.jsp", Long.valueOf(1505284427797L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"S_TYPE_S\" id=\"S_TYPE_S\" style=\"width:79px;\" type=\"text\" value=\"HSLTOKEN\" title=\"例子\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"step-content row-fluid position-relative\" style=\"padding-top: 10px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div style=\"float: left;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"input-icon\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"serverUrl\" title=\"输入请求地址\" value=\"http://localhost:8028/api/myLogApi/getMyLogDetails.do?HSLTOKEN=718\" style=\"width:540px;\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t相关参数协议：result: 000\t请求失败 ; 001\t请求成功; 002\t返回空值; 003\t请求协议参数不完整  ; 004  用户名或密码错误; 005  hslKey验证失败\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"text-warning green\"><i class=\"ace-icon fa fa-star blue\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t校验加密规则：(取其中一个参数名+当前日期[格式 20150405]+混淆码\",hsl,\" 然后md5加密 的值作为 参数hslKey的值提交)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
