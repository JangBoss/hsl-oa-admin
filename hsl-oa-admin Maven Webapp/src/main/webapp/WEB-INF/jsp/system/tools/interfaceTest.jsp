								...
								<div class="widget-body">
								 <div class="widget-main">
										<div class="step-content row-fluid position-relative">
											...
											<input name="S_TYPE_S" id="S_TYPE_S" style="width:79px;" type="text" value="HSLTOKEN" title="例子">
										</div>
										<div class="step-content row-fluid position-relative" style="padding-top: 10px;">
											<div style="float: left;">
												<span class="input-icon">
													<input type="text" id="serverUrl" title="输入请求地址" value="http://localhost:8028/api/myLogApi/getMyLogDetails.do?HSLTOKEN=718" style="width:540px;">
										...
										<div class="step-content row-fluid position-relative">
											<ul class="unstyled spaced2">
												<li class="text-warning orange"><i class="ace-icon fa fa-exclamation-triangle"></i>
													相关参数协议：result: 000	请求失败 ; 001	请求成功; 002	返回空值; 003	请求协议参数不完整  ; 004  用户名或密码错误; 005  hslKey验证失败
												</li>
												<li class="text-warning green"><i class="ace-icon fa fa-star blue"></i>
													校验加密规则：(取其中一个参数名+当前日期[格式 20150405]+混淆码",hsl," 然后md5加密 的值作为 参数hslKey的值提交)
												</li>
											</ul>
										</div>
