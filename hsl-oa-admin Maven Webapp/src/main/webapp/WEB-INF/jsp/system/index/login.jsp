...
<body>
	<div style="width:100%;text-align: center;margin: 0 auto;position: absolute;">
		<div id="loginbox">
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © 物联聚创OA 2017</span></font>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function severCheck(){
			if(check()){
				...
				var code = "qViewfh"+loginname+",fh,"+password+"QQ978336446fh"+",fh,"+$("#code").val();
				$.ajax({
					type: "POST",
					url: 'login_login',
		...
		function check() {
			...
			checkPwdValid = checkPassWord($("#password").val());
